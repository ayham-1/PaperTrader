...
This `getAssetValueWeek' instruction is from the set of data instructions. It
...
This `getAssetValueMonth' instruction is from the set of data instruction. It
gets the past months day's time frame of the data starting from the date passed
in with the the arguments. On success, the server would return using the data
transaction mechanism. On failure, the server would return the `dataFail'
instructionn.
